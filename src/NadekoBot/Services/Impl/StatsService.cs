...
namespace NadekoBot.Services.Impl
{
    public class StatsService : IStatsService
    {
        ...
        public const string BotVersion = "1.1.4-beta grin-0.0.8";

        public string Author => "Kwoth#2560 - Edited by Grinjr owo";
...
Servers: {client.Guilds.Count} | TextChannels: {TextChannels} | VoiceChannels: {VoiceChannels}
